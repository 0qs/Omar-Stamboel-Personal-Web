...
export default async function SkillsPage() {
  ...
  return (
    <div>
      ...
      {/* Stats section */}
      <Section title="Add Stat (shown in About section)">
        <form
          action={createStat}
          style={{ display: "flex", gap: "10px", alignItems: "flex-end", flexWrap: "wrap" }}
        >
    ...
    >
      <form action={updateWithId} style={{ display: "flex", gap: "8px", flex: 1, flexWrap: "wrap" }}>
        ...
        <input
          name="order"
          type="number"
          defaultValue={String(skill.order)}
          style={{ ...inputStyle, width: "60px" }}
        />
        <button type="submit" style={{ ...submitStyle, padding: "6px 12px" }}>
          Save
        </button>
      </form>
    ...
    >
      <form action={updateWithId} style={{ display: "flex", gap: "8px", flex: 1, flexWrap: "wrap" }}>
        ...
        <input
          name="order"
          type="number"
          defaultValue={String(stat.order)}
          style={{ ...inputStyle, width: "60px" }}
        />
        <button type="submit" style={{ ...submitStyle, padding: "6px 12px" }}>
          Save
